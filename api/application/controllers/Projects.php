...
class Projects extends REST_Controller {
	...
	{
		$this->response($this->projects_model->get_all());
	}
	...
	public function edit_get($id = NULL)
	{
		...
		$this->response($this->projects_model->get($id));
	}
