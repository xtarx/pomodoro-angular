...
class MY_Model extends CI_Model
{
    ...
    public function update_validation_array($array){


    $new_arr=array();
    foreach($array as $value){
        if($this->in_form_array($value['field'])){
        $new_arr[$value['field']] = $value;
        }
    } 
    return $new_arr;
}
...
/*
makes Dynamic Validations
for update/edit
it removes validaion from NON-existing Fields  (not NULL values)

 */
public function in_form_array($value){
...
return false;
    ...
    public function validate($data)
    {
        ...
        if(!empty($this->validate))
        {
            ...
            $this->validate = $this->update_validation_array($this->validate);
